...
BOT_TOKEN = environ.get('BOT_TOKEN', "7700984624:AAE1cebDV5VrWn6uQyWhd_PYH9a4gpZfH0g")
...
STREAM_API = (environ.get('STREAM_API', ' e78e5f774a9dede8f6b3d155a1fea041a35bb720'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/c/2292242367/20'))
...
DATABASE_NAME = environ.get('DATABASE_NAME', "dark_world")
...
MAX_B_TN = environ.get("MAX_B_TN", "100")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002529416267')) #Log channel id ( make sure bot is admin )
